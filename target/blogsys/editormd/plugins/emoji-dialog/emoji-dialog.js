                        ...
                        for (var x = 0; x < rowNumber; x++)
                        {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "")
                            {
                                ...
                                if (type === "github-emoji")
                                {
                                    ...
                                    var newsrc="editormd/plugins/emoji-dialog/emoji/";
                                ...
                                else if (type === "twemoji")
                                {
                                	...
                                	var twemojiSrc = (emoji === "+1") ? "plus1" : emoji;
                                	twemojiSrc     = (twemojiSrc === "black_large_square") ? "black_square" : twemojiSrc;
                                	twemojiSrc     = (twemojiSrc === "moon") ? "waxing_gibbous_moon" : twemojiSrc;
                                	var newsrc="editormd/plugins/emoji-dialog/twemoji/";
                                    twemojiSrc=newsrc+twemojiSrc+exports.twemoji.ext;
